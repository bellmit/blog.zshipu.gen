---
title: 阿里技术专家详解DDD系列 第五讲 - 聊聊如何避免写流水账代码
date: 2021-10-14T15:49:00
tags: [DDD]
---

转摘：https://zhuanlan.zhihu.com/p/366395817
...
![img](https://cdn.jsdelivr.net/gh/zshipu/images/202110151652326.png)
...
![img](https://cdn.jsdelivr.net/gh/zshipu/images/202110151652327.jpg)
...
![img](https://cdn.jsdelivr.net/gh/zshipu/images/202110151652328.jpg)
...
![img](https://cdn.jsdelivr.net/gh/zshipu/images/202110151652329.jpg)
...
![img](https://cdn.jsdelivr.net/gh/zshipu/images/202110151652330.jpg)
...
![img](https://cdn.jsdelivr.net/gh/zshipu/images/202110151652331.jpg)

有防腐层的情况：

![img](https://cdn.jsdelivr.net/gh/zshipu/images/202110151652332.jpg)
...
![img](https://cdn.jsdelivr.net/gh/zshipu/images/202110151652333.jpg)
...
![img](https://cdn.jsdelivr.net/gh/zshipu/images/202110151652335.jpg)

## **▐** **案例** 

用一个常见的例子：下单后支付并发货如果这个案例是Orchestration，则业务逻辑为：下单时从一个预存的账户里扣取资金，并且生成物流单发货，从图上看是这样的：

![img](https://cdn.jsdelivr.net/gh/zshipu/images/202110151652336.jpg)

如果这个案例是Choreography，则业务逻辑为：下单，然后等支付成功事件，然后再发货，类似这样：

![img](https://cdn.jsdelivr.net/gh/zshipu/images/202110151652337.jpg)
...
![img](https://cdn.jsdelivr.net/gh/zshipu/images/202110151652338.jpg)
...
![img](https://cdn.jsdelivr.net/gh/zshipu/images/202110151652339.jpg)

在代码中的依赖是比较明确的：如果你是下游，上游对你无感知，则只能走事件驱动；如果上游必须要对你有感知，则可以走指令驱动。反过来，如果你是上游，需要对下游强依赖，则是指令驱动；如果下游是谁无所谓，则可以走事件驱动。

2. 找出业务中的“负责人”：

![img](https://cdn.jsdelivr.net/gh/zshipu/images/202110151652340.jpg)
