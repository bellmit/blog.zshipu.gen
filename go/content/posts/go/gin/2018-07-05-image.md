...
首先，你需要在 App 配置项中增加二维码及其海报的存储路径，我们约定配置项名称为 `QrCodeSavePath`，值为 `qrcode/`，经过多节连载的你应该能够完成，若有不懂可参照 [go-gin-example](https://github.com/zshipu/go-gin-example/blob/master/conf/app.ini#L14)。
...
新增 [错误码](https://github.com/zshipu/go-gin-example/blob/master/pkg/e/code.go#L27)，[错误提示](https://github.com/zshipu/go-gin-example/blob/master/pkg/e/msg.go#L25)
