...
写入内容：[传送门](https://github.com/zshipu/go-gin-example/blob/master/service/cache_service/article.go)

（2）、打开 service 目录，新建 cache_service/tag.go

写入内容：[传送门](https://github.com/zshipu/go-gin-example/blob/master/service/cache_service/tag.go)
...
如果有疑惑，可以到 [go-gin-example](https://github.com/zshipu/go-gin-example) 看看我是怎么写的，你是怎么写的，又分别有什么优势、劣势，取长补短一波？
